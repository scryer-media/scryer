...
const ko: LocaleDictionary = {
  ...
  "settings.maintenanceRulesDarkTitle": "아직 활성화되지 않음",
  "settings.maintenanceRulesDarkBody": "유지 관리 규칙은 비활성 상태로 저장되며, 아직 이를 평가하거나 실행하는 것은 없습니다. 미리 보기만이 규칙을 실행하며, 무엇이 일치할지 보고할 뿐 타이틀, 파일, 모니터링을 변경하지 않습니다.",
