...
const it: LocaleDictionary = {
  ...
  "settings.maintenanceRulesDarkTitle": "Non ancora attivo",
  "settings.maintenanceRulesDarkBody": "Le regole di manutenzione vengono salvate disattivate e per ora nulla le valuta né le esegue. L'anteprima è l'unica cosa che esegue una regola e riporta solo ciò che corrisponderebbe: non tocca mai un titolo, un file o il monitoraggio.",
