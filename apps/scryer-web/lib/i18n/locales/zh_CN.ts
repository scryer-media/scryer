...
const zh_CN: LocaleDictionary = {
  ...
  "move.adoptionHeading": "目标位置有什么",
  "move.adoptionAccountedFor": "已核对",
  "move.adoptionMissing": "缺失",
  "move.adoptionAmbiguous": "无法确定",
  "move.adoptionAdditional": "额外文件",
  "move.adoptionBlocked": "有 {{count}} 个受管理的文件无法在目标位置核对，因此无法开始接管。请先解决这些文件，或取消选择该标题。",
  "move.adoptionMissingHeading": "在目标位置找不到",
  "move.adoptionAmbiguousHeading": "有多个文件可能与之对应",
  "move.adoptionUnreadableHeading": "无法读取目标位置",
  "move.adoptionBlockedReason.adoption_media_missing": "在目标位置找不到该标题的受管理文件",
  "move.adoptionBlockedReason.adoption_media_ambiguous": "目标位置有多个文件可能是该标题的受管理文件",
  "move.adoptionBlockedReason.adoption_destination_unreadable": "无法读取该标题的目标文件夹",
  "move.adoptionAdditionalHeading": "位于目标位置但未被管理",
  "move.adoptionSampled": "仅显示部分未解决的文件；计划中还有更多。",
  "move.adoptionSourceCleanup": "接管不会删除旧位置的任何内容。只有当目标文件被证明与目录中保存的完整哈希一致时，才会把源副本移入回收站。",
  ...
  "move.freeSpaceSameVolume": "同一卷：这是重命名，无需额外空间。",
