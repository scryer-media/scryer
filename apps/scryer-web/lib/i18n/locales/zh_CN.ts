...
const zh_CN: LocaleDictionary = {
  ...
  "rootChange.crossRouteToConsolidation": "该路径已经是本媒体库的一个根目录，因此这属于合并。目标已为你切换。",
  "rootChange.crossRouteToNewPath": "该根目录未在本媒体库中配置，因此这属于更改根目录。目标已为你切换。",
  ...
  "rootChange.refusal.root_change_destination_is_configured_root": "该路径已经是本媒体库的一个根目录。",
  ...
  "rootChange.refusal.root_consolidation_destination_not_a_configured_root": "该根目录未在本媒体库中配置。",
