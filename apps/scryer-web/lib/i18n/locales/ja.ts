...
const ja: LocaleDictionary = {
  ...
  settings: "設定",
  "settings.navGroup.account": "アカウント",
  "settings.navGroup.catalogs": "カタログ",
  "settings.navGroup.integrations": "連携",
  "settings.navGroup.system": "システム",
  ...
  "search.goToHint": "ナビゲーションとアクション",
  "search.alreadyInCollection": "すでにコレクション内",
  "search.everywhereElse": "その他",
  ...
  "search.viewAll.movie": "すべての映画を表示",
  "search.viewAll.series": "すべてのシリーズを表示",
  "search.viewAll.anime": "すべてのアニメを表示",
  "search.add": "追加",
  "search.footerTip":
  ...
  "settings.currentPermissions": "現在の権限",
  ...
  "settings.trashPackFilterLabel": "タグフィルター",
  "settings.trashPackFilterPlaceholder": "locale:french, locale:vf",
  "settings.trashPackFilterHelp": "カンマ区切り。空欄の場合はすべてに適用されます。",
  "settings.trashPackFilterSaved": "{{name}} のタグフィルターを更新しました",
  ...
  "settings.sub.serviceStatus": "字幕サービス",
  "settings.sub.serviceStatusAvailable": "利用可能",
  "settings.sub.serviceStatusUnavailable": "利用不可",
  ...
  "subtitle.flags": "フラグ",
  "subtitle.noneDownloaded": "外部字幕はダウンロードされていません。",
