...
const ja: LocaleDictionary = {
  ...
  "settings.maintenanceRulesDarkTitle": "まだ有効ではありません",
  "settings.maintenanceRulesDarkBody": "メンテナンスルールは無効の状態で保存され、まだ何もそれを評価・実行しません。ルールを実行するのはプレビューだけで、何が一致するかを報告するのみです。タイトル、ファイル、モニタリングには一切触れません。",
