...
const en: LocaleDictionary = {
  ...
  "settings.maintenanceRulesDarkTitle": "Not active yet",
  "settings.maintenanceRulesDarkBody": "Maintenance rules are saved disabled and nothing evaluates or executes them yet. Preview is the only thing that runs a rule, and it only reports what would match — it never touches a title, a file, or monitoring.",
