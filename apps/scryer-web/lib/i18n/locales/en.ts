...
const en: LocaleDictionary = {
  ...
  "settings.maintenanceSequenceSummaryRisk": "Highest risk: {{risk}}",
  "settings.maintenanceSequenceSummaryArming": "Requires: {{arming}} arming",
  ...
  "settings.maintenanceRuleReviewRequired": "Review required before destructive arming: new show watch and episode facts can change this rule's matches.",
  ...
  "move.cancelRequested": "Cancellation requested; the operation stops at the next title.",
  "move.cancelNotPossible": "This operation has already finished.",
  "move.cancelFailed": "Failed to request cancellation.",
  "move.cancelDraining": "Stopping at the next title",
