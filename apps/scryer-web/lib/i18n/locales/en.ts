...
const en: LocaleDictionary = {
  ...
  "settings.libraryScanFoundTitles": "Found {{count}} folders",
  "settings.libraryScanDiscovering": "Finding titles…",
  "settings.libraryScanProgressPending": "Waiting for discovery…",
  "settings.libraryScanProgressCalculatingTotal": "Calculating total…",
  "settings.libraryScanFetchingMetadata": "Fetching Metadata",
  "settings.libraryScanFilesScanned": "Files scanned",
  "settings.libraryScanNoMetadataNeeded": "No metadata fetch needed",
  "settings.libraryScanNoFilesToScan": "No files to scan",
  ...
  "queue.assignTitleBeforeImport": "Assign a title before starting manual import.",
  "queue.ignore": "Ignore",
  ...
  "wanted.context.franchiseMovie": "Franchise movie wanted item",
