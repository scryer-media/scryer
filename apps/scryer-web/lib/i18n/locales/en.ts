...
const en: LocaleDictionary = {
  ...
  "move.adoptionHeading": "What is at the destination",
  "move.adoptionAccountedFor": "Accounted for",
  "move.adoptionMissing": "Missing",
  "move.adoptionAmbiguous": "Ambiguous",
  "move.adoptionAdditional": "Additional",
  "move.adoptionBlocked": "{{count}} tracked file(s) cannot be accounted for at the destination, so this adoption cannot start. Resolve them or deselect the title.",
  "move.adoptionMissingHeading": "Not found at the destination",
  "move.adoptionAmbiguousHeading": "More than one file could be this one",
  "move.adoptionUnreadableHeading": "Destination could not be read",
  "move.adoptionBlockedReason.adoption_media_missing": "Tracked files for this title were not found at the destination",
  "move.adoptionBlockedReason.adoption_media_ambiguous": "More than one destination file could be a tracked file for this title",
  "move.adoptionBlockedReason.adoption_destination_unreadable": "The destination folder for this title could not be read",
  "move.adoptionAdditionalHeading": "At the destination but not tracked",
  "move.adoptionSampled": "Showing a sample of the unresolved files; the plan holds more.",
  "move.adoptionSourceCleanup": "Adoption deletes nothing at the old location. A source copy is recycled only when the destination is proven identical to the full hash the catalog holds.",
