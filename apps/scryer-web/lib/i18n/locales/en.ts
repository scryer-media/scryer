...
const en: LocaleDictionary = {
  ...
  "mediaInfo.discSkip": "Skip (unassigned)",
  "mediaInfo.discAutomaticChoice": "Automatic longest title",
  "mediaInfo.discNoTitles": "No supported disc titles were found. The source will remain in place.",
  ...
  "label.noMatchingOptions": "No matching options",
  ...
  "dashboard.newImportBadge": "New import",
  ...
  "settings.indexerSearch": "Indexer Search",
  "settings.indexerSearchBetaNotice": "Indexer Search is in beta. Its behaviour and results may still change between releases.",
  ...
  "settings.proxiesHelp": "Proxies carry traffic for the indexers and download clients you assign them to. A solver answers browser challenges, a standard proxy is an HTTP or SOCKS hop, and a tunnel dials its own transport.",
  "settings.proxyFamilySolver": "Solver",
  "settings.proxyFamilyStandard": "Standard",
  "settings.proxyFamilyTunnel": "Tunnel",
  "settings.proxyFamilyOther": "Other",
  "settings.proxyHealth": "Health",
  "settings.proxyLastError": "Last error",
  "settings.proxyHealthHealthy": "Healthy",
  "settings.proxyHealthUnhealthy": "Unhealthy",
  "settings.proxyEmpty": "No proxies configured.",
  "settings.proxyTest": "Test",
  "settings.proxyTestTitle": "Test {{name}}",
  "settings.proxyTestUrl": "Test URL",
  "settings.proxyTestDescription": "Fetch this URL through the saved proxy and show the public IP reported by the endpoint.",
  "settings.proxyTestSolverDescription": "Ask the solver to fetch this URL and show its outbound IP. This checks fetching, but does not verify challenge solving or the route used by other Scryer traffic.",
  "settings.proxyTestRunning": "Testing the outbound connection…",
  "settings.proxyTestExitIp": "Proxy exit IP",
  "settings.proxyTestSolverIp": "Solver exit IP",
  "settings.proxyTestNoIp": "Response did not contain a recognizable IP.",
  "settings.proxyTimeout": "Timeout",
  "settings.proxyCreateNew": "Connect proxy",
  "settings.proxyCreate": "Create proxy",
  "settings.proxyUpdate": "Update proxy",
  "settings.proxyDeleteConfirmDescription": "Delete proxy {{name}}?",
  "settings.proxyValidation": "A name and a base URL are required.",
  "settings.proxyEndpoint": "Endpoint",
  "settings.proxyEndpointHelp": "ssh://host:port. Port 22 is used when you leave it out.",
  "settings.proxyAssignment": "Proxy",
  "settings.proxyDirect": "Direct (no proxy)",
  "settings.proxyMissing": "Missing proxy",
  "settings.proxyMissingHelp": "The assigned proxy was not found.",
  "settings.proxyDisabledHelp": "The assigned proxy is disabled.",
  "settings.proxyDisabledSuffix": "(disabled)",
  "settings.proxyClearPassword": "Clear stored password",
  "settings.proxyTunnelAuthHelp": "SSH requires a username and an Ed25519 private key. Password authentication is not supported.",
  "settings.proxyPrivateKey": "Private key",
  "settings.proxyPrivateKeyHelp": "only Ed25519 private keys are supported; generate one with `ssh-keygen -t ed25519` and paste the OpenSSH private key",
  "settings.proxyPrivateKeyStored": "Private key set",
  "settings.proxyPrivateKeyUnchanged": "A private key is stored. Paste a new one to replace it.",
  "settings.proxyClearPrivateKey": "Clear stored private key",
  "settings.proxyPrivateKeyPassphrase": "Key passphrase",
  "settings.proxyPrivateKeyPassphraseHelp": "Only needed when the private key is passphrase protected.",
  "settings.proxyHostKey": "Host key",
  "settings.proxyHostKeyPinnedAt": "Pinned {{time}}.",
  "settings.proxyHostKeyUnpinned": "Not pinned yet. The first successful connection pins the server's host key.",
  "settings.proxyHostKeyReset": "Reset host key",
  "settings.proxyHostKeyResetDescription": "Forget the pinned host key. The next connection trusts and pins whatever the server offers, so do this only when you know the server's key really changed.",
  "settings.proxyValidationTunnelUsername": "A tunnel needs a username.",
  "settings.proxyValidationTunnelAuth": "An SSH tunnel needs an Ed25519 private key.",
  "settings.downloadClientProxyHelp": "Any proxy kind may be assigned. A challenge solver has no effect on a native client, whose requests are not made by a plugin guest.",
  "status.proxyCreated": "Proxy created.",
  "status.proxyUpdated": "Proxy updated.",
  "status.proxyDeleted": "Deleted proxy {{name}}.",
  "status.proxyTestPassed": "Proxy test passed.",
  "status.proxyTestFailed": "Proxy test failed.",
  "status.editingProxy": "Editing proxy {{name}}.",
  "status.proxyHostKeyReset": "Host key reset for {{name}}. The next connection pins the server again.",
  "settings.proxyEndpointHelpHttp3": "https://host:port (443 by default). Uses HTTP/3 CONNECT over QUIC with verified TLS. Assign an indexer to test the route.",
  "settings.proxyEndpointHelpWireguard": "wireguard://host:port. Port 51820 is used when you leave it out.",
  "settings.proxyPrivateKeyHelpWireguard": "WireGuard keys are 32 bytes of base64, exactly as `wg genkey` prints them (44 characters ending in `=`)",
  "settings.proxyPeerPublicKey": "Peer public key",
  "settings.proxyPeerPublicKeyHelp": "The `PublicKey` line from the server's `[Peer]` section. A public key is public, so it is shown in full.",
  "settings.proxyPresharedKey": "Preshared key",
  "settings.proxyPresharedKeyHelp": "Optional. The `PresharedKey` line, when the server uses one.",
  "settings.proxyPresharedKeyStored": "Preshared key set",
  "settings.proxyPresharedKeyUnchanged": "A preshared key is stored. Paste a new one to replace it.",
  "settings.proxyClearPresharedKey": "Clear stored preshared key",
  "settings.proxyTunnelAddresses": "Addresses",
  "settings.proxyTunnelAddressesHelp": "The `Address` line from the `[Interface]` section, for example 10.6.0.2/32. One per line, or comma separated.",
  "settings.proxyTunnelDnsServers": "DNS servers",
  "settings.proxyTunnelDnsServersHelp": "Optional resolvers reached through the tunnel, one per line or comma separated. Without one, destinations must be addressed by IP.",
  "settings.proxyTunnelMtu": "MTU",
  "settings.proxyTunnelMtuHelp": "Optional, between {{min}} and {{max}}. Leave it empty for the default of {{default}}.",
  "settings.proxyTunnelKeepalive": "Keepalive",
  "settings.proxyTunnelKeepaliveHelp": "Optional, in seconds. Leave it empty for the default of {{default}}, or set 0 to switch keepalive off.",
  "settings.proxyTunnelPublicKey": "This tunnel's public key",
  "settings.proxyTunnelPublicKeyHelp": "Paste this into the server's `[Peer]` section as its `PublicKey` line.",
  "settings.proxyTunnelPublicKeyPending": "Saved after the private key is stored.",
  "settings.proxyTunnelPublicKeyCopy": "Copy",
  "settings.proxyImportConfig": "Import a WireGuard configuration",
  "settings.proxyImportConfigHelp": "Paste the whole configuration your VPN provider gave you, or choose the .conf file, and the fields below are filled from it. Every field also takes a single line pasted on its own.",
  "settings.proxyImportConfigApply": "Fill the form",
  "settings.proxyImportConfigFile": "Choose a file",
  "status.proxyImportConfigFilled": "Filled the form from the WireGuard configuration.",
  "status.proxyImportConfigUnreadable": "That does not look like a WireGuard configuration.",
  "status.proxyImportConfigFirstPeer": "It has {{count}} peers; only the first was imported.",
  "status.proxyImportConfigIgnored": "Ignored {{keys}}, which a tunnel proxy does not use.",
  "settings.proxyValidationWireguardPrivateKey": "WireGuard needs a private key.",
  "settings.proxyValidationWireguardPeerPublicKey": "WireGuard needs the peer's public key.",
  "settings.proxyValidationWireguardAddresses": "WireGuard needs at least one interface address, for example 10.6.0.2/32.",
  "settings.proxyValidationWireguardKeyShape": "{{field}} does not look like a WireGuard key: they are 32 bytes of base64, exactly as `wg genkey` prints them (44 characters ending in `=`).",
  "settings.proxyValidationWireguardMtu": "The tunnel MTU must be between {{min}} and {{max}}.",
  "settings.proxyValidationWireguardKeepalive": "Keepalive is a whole number of seconds, and 0 switches it off.",
  "status.proxyTunnelPublicKeyCopied": "Public key copied.",
  "status.proxyTunnelPublicKeyCopyFailed": "Unable to copy the public key.",
  ...
  "settings.verificationDepthScope": "This applies to download-client import copies only. Library and root moves always verify in full, whatever is chosen here.",
  "settings.verificationDepthLabel": "Verification depth",
  "settings.verificationDepthFull": "Full read-back (default)",
  "settings.verificationDepthFullHelp": "Reads the copy back in full and compares it against the checksum streamed during the copy.",
  "settings.verificationDepthQuick": "Quick check",
  "settings.verificationDepthQuickHelp": "Compares the file size and the sampled head and tail content. Faster, and a weaker guarantee.",
  "settings.verificationDepthSaved": "Verification depth saved.",
  ...
  "search.monitorType.advanced": "Advanced",

  "monitorSelection.seasons": "Seasons",
  ...
  "monitorSelection.loading": "Loading seasons…",
  "monitorSelection.loadFailed": "Could not load seasons for this title.",
  "monitorSelection.noSeasons": "No seasons were returned for this title.",
  "monitorSelection.unavailable":
    "Advanced monitoring needs a TVDB match, which this result does not have.",
  "monitorSelection.emptyHint": "Pick at least one season or series movie.",
  "monitorSelection.summaryPrefix": "Requested: {{selection}}",
  "monitorSelection.summaryMovies": "Movies: {{movies}}",
  ...
  "pendingImports.searchYearLabel": "Year",
  "pendingImports.searchYearPlaceholder": "Year",
  "pendingImports.searchYearClear": "Clear year",
  "pendingImports.searchYearHint": "The year comes from the scan. Clear it to widen the search when the filename year is wrong.",
  "pendingImports.searching": "Searching metadata…",
  "pendingImports.searchFailed": "Failed to search metadata.",
  "pendingImports.searchRequestFailed": "Metadata search failed: {{error}}",
  ...
  "pendingImports.alreadyInLibrary": "Already in this library",
  "pendingImports.attachToExistingTitle": "Attach to existing title",
  "pendingImports.attachSuccess": "Attached pending import to {{name}}.",
  ...
  "queue.state.waitingForDiskSpace": "Waiting for disk space",
  "activity.refreshTimedOut": "Refresh timed out",
  "activity.refreshBehind": "Queue refresh did not reach the latest update. Retry.",
  "activity.retry": "Retry",
  "activity.loadMore": "Load more",
  "activity.staleData": "Showing the last successful result. Refresh failed.",
  "activity.countUnknown": "Import attention count is not available yet",
  "activity.countStale": "Import attention count may be out of date",
  ...
  "settings.refReleaseStereoscopy": "Presentation claimed by the release name; null means unknown",
  "settings.refSectionStereoscopy": "— Stereoscopic presentation",
  "settings.refStereoPresentation": "two_d, three_d, or mixed_2d_3d; these are name claims, not verified stream properties",
  "settings.refStereoLayout": "side_by_side, top_bottom, frame_sequential, row_interleaved, column_interleaved, checkerboard, or anaglyph; null when unspecified, conflicting, or mixed",
  "settings.refStereoSampling": "half or full for side-by-side or top/bottom; null when unknown",
  "settings.refStereoEncoding": "mvc when explicitly corroborated by a 3D marker; null when unknown",
  "settings.refReleaseStereoscopyTokens": "Canonical stereo tokens: stereo:two_d, stereo:three_d, stereo:mixed_2d_3d, stereo:has_3d, stereo:layout:<layout>, stereo:sampling:half/full, stereo:encoding:mvc, and stereo:<field>_conflict. Empty means unknown. Raw normalized_tokens retain their original meaning.",
  ...
  "seriesOverview.selectSeasonForDelete": "Select all episodes in {{name}}",
  "seriesOverview.clearEpisodeSelection": "Clear selection",
  "seriesOverview.deleteSelectedEpisodeFiles": "Delete {{count}} selected",
  "seriesOverview.deleteEpisodeFilesTitle": "Delete selected episode files",
  "seriesOverview.deleteEpisodeFilesDescription":
    "This permanently deletes the files on disk for the selected episodes. Episode records are kept.",
  "seriesOverview.deleteEpisodeFilesSummary":
    "{{files}} files across {{episodes}} episodes",
  ...
  "mediaFile.commentary": "Commentary",
  "mediaFile.audioDescription": "Audio description",
  "mediaFile.hearingImpaired": "Hearing impaired",
  "mediaFile.program": "Program {{id}}",
  "mediaFile.discTitle": "Disc playback title",
  "mediaFile.discReviewAction": "Disc needs attention",
  "mediaFile.discOutcomeAutomatic": "Playing title {{id}} ({{duration}}), chosen automatically as the longest complete title.",
  "mediaFile.discOutcomeManual": "Playing title {{id}} ({{duration}}), chosen by you. Automatic selection is off for this disc.",
  "mediaFile.discOutcomeUnselected": "No playable title could be chosen. Pick one below.",
  "mediaFile.discOutcomeIncomplete": "The chosen title's inspection did not complete ({{status}}). Pick a complete title or re-check the file.",
  "mediaFile.discChooseTitle": "Which title should play",
  "mediaFile.discAutomaticCurrent": "Currently title {{id}}",
  "mediaFile.discTitleChapterCount": "{{count}} chapter(s)",
  "mediaFile.discTitleAudioCount": "{{count}} audio track(s)",
  "mediaFile.discTitleNotSelectable": "Inspection {{status}}",
  "mediaFile.discTitleMissing": "No longer on the disc",
  "mediaFile.discPlaying": "Playing",
  "mediaFile.discUseTitle": "Use this title",
  "mediaFile.discStreamsAndChapters": "Streams and chapters",
  "mediaFile.discTechnicalDetails": "Technical details",
  "mediaFile.discTitleIdentity": "Title {{id}}",
  "mediaFile.discInspectTitles": "Inspect title streams and chapters",
  "mediaFile.discAngleInventory": "{{count}} angle(s). Media inspection covers the first angle when available.",
  "mediaFile.discTitleAliases": "Equivalent title IDs: {{ids}}",
  "mediaFile.discTitleBudgetExhausted": "Inspection of this title reached its probe budget.",
  "mediaFile.discTitleStreams": "Title streams",
  "mediaFile.discTitleStreamsUnknown": "No stream metadata was recovered for this title.",
  "mediaFile.discTitleChapters": "Title chapters",
  "mediaFile.discTitleChaptersUnknown": "No chapter metadata was recovered for this title.",
  "mediaFile.discChapterIdentity": "Chapter {{id}}",
  "mediaFile.discEpisodeMapping": "Map disc titles to episodes",
  "mediaFile.discMappingScope": "Choose one episode for each authored playback title. Unmapped titles do not make episodes available. The ISO stays one file.",
  "mediaFile.discMappingSave": "Save episode mappings",
  "mediaFile.discMappingFailed": "Could not save the episode mappings",
  "mediaFile.discMappingLoading": "Loading episodes…",
  "mediaFile.discMappingNone": "No episode",
  "mediaFile.discAutomatic": "Automatic longest valid title",
  "mediaFile.discSaving": "Inspecting title…",
  "mediaFile.discSelectionFailed": "Could not save the disc title selection",
  "mediaFile.analysisHeading": "Media inspection {{status}}",
  "mediaFile.analysisLatestInspection": "Latest inspection {{status}} at {{time}}",
  "mediaFile.analysisPreviousRetained": "The previous saved inspection is retained.",
  "mediaFile.analysisNoneSaved": "No inspection has been saved for this file.",
  "mediaFile.analysisBudgetExhausted": "The inspection budget was exhausted.",
  "mediaFile.analysisSummary": "Duration {{duration}} · overall {{overall}} · video {{video}}",
  "mediaFile.analysisBudgetStopped": "Inspection stopped at its probe budget.",
  "mediaFile.analysisProgram": "Program {{id}}",
  "mediaFile.analysisProgramStreams": "streams {{ids}}",
  "mediaFile.analysisSelected": "selected",
  "mediaFile.analysisChapters": "Chapters",
  "mediaFile.analysisAttachments": "Attachments",
  "mediaFile.analysisUnknownType": "unknown type",
  "mediaFile.analysisBytes": "{{count}} bytes",
  "mediaFile.analysisCaptionService": "{{standard}} caption service {{number}} · {{language}}",
  "mediaFile.analysisUnknownLanguage": "unknown language",
  "mediaFile.streamUnknownCodec": "unknown codec",
  "mediaFile.streamLanguage": "Language",
  "mediaFile.streamProfileLevel": "Profile / level",
  "mediaFile.streamBitrate": "Bitrate",
  "mediaFile.streamEstimatedBitrate": "Estimated bitrate",
  "mediaFile.streamDimensions": "Dimensions",
  "mediaFile.streamPixelFormat": "Pixel format / depth",
  "mediaFile.streamFieldOrder": "Field order",
  "mediaFile.streamAspectRotation": "Aspect / rotation",
  "mediaFile.streamDeclaredFrameRate": "Declared frame rate",
  "mediaFile.streamObservedFrameRate": "Observed frame rate",
  "mediaFile.streamVfrUnknown": "variable frame rate unknown",
  "mediaFile.streamVfrObserved": "variable frame rate observed",
  "mediaFile.streamVfrNotObserved": "constant frame rate",
  "mediaFile.streamHdr": "HDR signals",
  "mediaFile.streamNoHdr": "none",
  "mediaFile.streamColor": "Color primaries / transfer / matrix",
  "mediaFile.streamContentLight": "MaxCLL / MaxFALL",
  "mediaFile.streamMasteringLuminance": "Mastering luminance",
  "mediaFile.streamDolbyVision": "Dolby Vision profile / compatibility",
  "mediaFile.streamChannels": "Channels / layout",
  "mediaFile.streamSampleRate": "Sample rate / format",
  "mediaFile.streamSampleDepth": "Sample depth",
  "mediaFile.streamUnknownLayout": "unknown layout",
  "mediaFile.diagnose": "Inspect structural headers",
  "mediaFile.diagnosing": "Inspecting headers…",
  "mediaFile.diagnosticsFailed": "Could not inspect this file",
  "mediaFile.diagnosticsScope": "Bounded header sampling does not validate every packet or decoded picture and audio content.",
  "mediaFile.diagnosticsRead": "{{bytes}} bytes read in {{milliseconds}} ms",
  "mediaFile.diagnosticsSamples": "{{packets}} transport packets and {{frames}} frame headers sampled",
  "mediaFile.diagnosticsCoverage": "{{percent}}% of source bytes inspected",
  "mediaFile.diagnosticsRanges": "Inspected byte ranges",
  "mediaFile.diagnosticsTruncated": "Some ranges or warnings were omitted because the report limit was reached.",
  ...
  "wanted.searchJobProgress": "{{processed}}/{{total}} search steps completed. {{title}}",
  "wanted.searchNoEligibleWork": "No monitored items need downloading or upgrading.",
  "wanted.searchNoAcceptableReleases": "Search completed; no acceptable releases found.",
  "wanted.searchSnapshotMissing": "The search response was incomplete. Check Activity before trying again.",
  "wanted.searchInvalidSeason": "This season could not be identified. Refresh the title and try again.",
  ...
  "settings.notificationEvent.listTitleAdded": "List Added Title",
  "settings.notificationEvent.listRequestSubmitted": "List Request Submitted",
  "settings.notificationEvent.listItemHeld": "List Item Held",
  "settings.notificationEvent.listTitleLeft": "Title Left List",
  "settings.notificationEvent.listSyncFailed": "List Sync Failed",
  "settings.notificationEvent.listUnfollowed": "List Unfollowed",
  ...
  "settings.maintenanceActionSequence": "Action sequence",
  "settings.maintenanceSequenceTitle": "Action sequence",
  "settings.maintenanceSequenceHelp": "Run these steps in order after a subject has completed its grace period. An empty sequence observes matches without applying effects.",
  "settings.maintenanceSequenceEmpty": "Observe only — no action steps are configured.",
  "settings.maintenanceSequenceObserveOnly": "Observe only",
  "settings.maintenanceSequenceSummary": "Sequence summary",
  "settings.maintenanceSequenceSummaryTarget": "Targets: {{target}}",
  "settings.maintenanceSequenceSummaryArming": "Effect access: {{arming}}",
  "settings.maintenanceSequenceSummaryEffects": "Effects: {{effects}}",
  "settings.maintenanceSequenceTargetTitle": "matching title",
  "settings.maintenanceSequenceTargetTitleDescendants": "matching title, seasons, and episodes",
  "settings.maintenanceSequenceTargetSeason": "matching season",
  "settings.maintenanceSequenceTargetSeasonDescendants": "matching season and episodes",
  "settings.maintenanceSequenceTargetEpisode": "matching episode",
  "settings.maintenanceSequencePreviewPlan": "Ordered effects for this preview",
  "settings.maintenanceSequencePreviewDescendants": "include descendants",
  "settings.maintenanceSequencePreviewMatchedScope": "matched scope only",
  "settings.maintenanceSequenceAdd": "Add step",
  "settings.maintenanceSequencePreset": "Sequence preset",
  "settings.maintenanceSequencePresetApply": "Replace with preset",
  "settings.maintenanceSequencePresetProfileThenSearch": "Change profile, then search if it changed",
  "settings.maintenanceSequencePresetUnmonitorThenDelete": "Unmonitor descendants, then delete files",
  "settings.maintenanceSequenceTerminal": "Terminal",
  "settings.maintenanceSequenceDependencies": "Requires: {{steps}}",
  "settings.maintenanceSequenceIncludeDescendants": "Include seasons and episodes",
  "settings.maintenanceSequenceSearchCondition": "Search condition",
  "settings.maintenanceSequenceSearchUnconditional": "Always request search",
  "settings.maintenanceSequenceSearchPreviousProfileChanged": "Only after the profile changed",
  "settings.maintenanceSequenceSearchRequested": "This step requests a search and records accepted only after the request is accepted. Later acquisition and download effects can still be held.",
  "settings.maintenanceSequenceHistoryWaiting": "waiting for an earlier step",
  "settings.maintenanceSequenceHistorySearchRequested": "search requested",
  "settings.maintenanceSequenceHistorySearchAccepted": "accepted",
  "settings.maintenanceSequenceHistoryJob": "job {{id}}",
  "settings.maintenanceSequenceCompletionAccepted": "Completes when accepted",
  "settings.maintenanceSequenceCompletionCompleted": "Completes when finished",
  "settings.maintenanceSequenceStepUnavailable": "This saved step is unavailable from the current catalog. Remove it or restore a compatible catalog before saving or previewing.",
  "settings.maintenanceSequenceCatalogUnavailable": "The action-step catalog is unavailable. Saved steps remain visible, but saving and unsaved previews are paused until it loads.",
  "settings.maintenanceSequenceStepUnmonitor": "Unmonitor",
  "settings.maintenanceSequenceStepDeleteFiles": "Delete files",
  "settings.maintenanceSequenceStepChangeQualityProfile": "Change quality profile",
  "settings.maintenanceSequenceStepSearch": "Search",
  "settings.maintenanceSequenceStepAddTags": "Add tags",
  "settings.maintenanceSequenceStepRemoveTags": "Remove tags",
  "settings.maintenanceSequenceStepDeleteTitleAndFiles": "Delete title and files",
  "settings.maintenanceRuleGraceDays": "Grace days",
  "settings.maintenanceRuleGraceDaysHelp": "Days after each subject first matches before its action becomes due.",
  ...
  "settings.maintenanceRuleStorageRoot": "Storage root",
  "settings.maintenanceRuleStorageRootNone": "No storage root selected",
  "settings.maintenanceRuleStorageRootHelp": "Select a configured root to read its capacity and limit file deletion to files actually on that root.",
  "settings.maintenanceRuleStorageRootUnmonitorHelp": "The selected root limits only file deletion. Unmonitoring still applies to the entire matched subject, so files on other roots are retained but no longer monitored.",
  "settings.maintenanceRuleStorageRootClear": "Clear storage root",
  "settings.maintenanceStorageRootFileSummary": "Selected root: {{count}} files · {{size}}",
  ...
  "settings.maintenanceRuleSaveDisabledNote": "New rules are disabled and unarmed. Review the preview before enabling evaluation and arming actions.",
  ...
  "settings.maintenancePreviewSubtitle": "Run the matcher against titles, seasons, or episodes in its scope. Preview reports what would match and changes nothing.",
  ...
  "settings.maintenancePreviewLimit": "Subjects",
  "settings.maintenancePreviewLimitHelp": "Up to {{max}} subjects per run.",
  ...
  "settings.maintenanceStatusReversibleTitle": "Library updates can execute",
  "settings.maintenanceStatusReversibleBody": "Rules configured for library updates may act on their candidates. File deletion has its own setting.",
  "settings.maintenanceStatusDestructiveTitle": "File deletion is enabled",
  "settings.maintenanceStatusDestructiveBody": "Rules configured for file deletion can delete files from matching titles after each grace period elapses.",
  ...
  "settings.maintenanceGateReversibleEffects": "Library updates",
  "settings.maintenanceGateReversibleEffectsHelp": "Allows actions such as unmonitoring or changing a quality profile. Files are kept.",
  "settings.maintenanceGateDestructiveEffects": "File deletion",
  "settings.maintenanceGateDestructiveEffectsHelp": "Allows rules configured for file deletion to delete matching files from disk.",
  "settings.maintenanceGateDestructiveConfirmTitle": "Enable file deletion?",
  "settings.maintenanceGateDestructiveConfirmBody": "Enabling this setting lets rules configured for file deletion delete matching files after each grace period elapses.",
  "settings.maintenanceGateDestructiveConfirmAction": "Enable file deletion",
  ...
  "settings.maintenanceRuleArming": "Effects",
  "settings.maintenanceRuleArmingHelp": "Effect access is per rule and independent of mode. The matching instance setting must be enabled before an effect runs.",
  ...
  "settings.maintenanceArmingReversible": "Library updates",
  "settings.maintenanceArmingDestructive": "File deletion",
  "settings.maintenanceArmDestructiveTitle": "Enable file deletion?",
  "settings.maintenanceArmDestructiveBody": "{{name}} deletes files. Enabling file deletion lets it act on its existing candidates when file deletion is enabled and each grace period elapses.",
  ...
  "settings.maintenanceArmDestructiveCountChanged": "The candidate count changed: this rule now holds {{count}}. Confirm the current count to continue.",
  "settings.maintenanceArmDestructiveAcknowledge": "Enable file deletion for {{count}} titles.",
  "settings.maintenanceArmDestructiveConfirm": "Enable file deletion",
  ...
  "settings.maintenanceFileSummary": "{{count}} files · {{size}}",
  "settings.maintenanceTestTitle": "Choose a title to test",
  "settings.maintenanceNoSubjects": "No subjects in this title for the selected scope.",
  "settings.maintenancePreviewExcluded": "Excluded from actions",
  "settings.maintenancePreviewEstimatedDue": "If matched now: {{time}}",
  "settings.maintenancePreviewDue": "Grace deadline: {{time}}",
  "settings.maintenancePreviewSubject": "Test subject",
  "settings.maintenancePreviewSample": "Library sample",
  "settings.maintenanceRuleScope": "Rule scope",
  "settings.maintenanceScopeSeason": "Season",
  "settings.maintenanceScopeEpisode": "Episode",
  "settings.maintenanceFileDeleted": "Deleted",
  "settings.maintenanceFilePending": "Pending",
  "settings.maintenanceFileResults": "File results",
  "settings.maintenanceFileProgress": "{{completed}} deleted · {{remaining}} remaining",
  "settings.refMaintSubjectId": "Scryer title, collection, or episode ID for the selected scope",
  "settings.refMaintCollectionId": "Owning season collection ID for season and episode subjects, when known",
  ...
  "settings.refMaintSubjectSeasonNumber": "Season number for season and episode subjects, when known",
  ...
  "settings.refMaintSubjectName": "Display label of the title, season, or episode",
  ...
  "settings.refMaintFactsTags":
    "User-defined tags inherited from the owning title, lowercase, from the tag registry an administrator maintains in Settings; reserved scryer: settings entries are excluded",
  "settings.refMaintFactsQualityProfileId": "Quality profile inherited from the owning title",
  ...
  "settings.refMaintFactsEpisodePositionByAirDate": "Episode rank by air date within its show",
  "settings.refMaintFactsSeasonPositionByAirDate": "Season rank by newest eligible downloaded episode",
  "settings.refMaintFactsStorageRootId": "Configured root selected for storage capacity and file deletion",
  "settings.refMaintFactsStorageAvailableBytes": "Bytes currently available on the selected root",
  "settings.refMaintFactsStorageTotalBytes": "Total capacity in bytes of the selected root",
  "settings.refMaintFactsStorageAvailablePercent": "Percentage of the selected root currently available",
  "settings.refMaintFactsActiveDownloads": "Whether the subject has a download in flight",
  "settings.refMaintFactsWatchedByUserIds": "Users who watched this episode; for seasons, the same users must have watched every aired episode, including missing files. Future episodes are excluded; unresolved air dates or incomplete signals are unknown. Empty seasons are never completed.",
  ...
  "settings.refMaintFactsKeepClaimActive":
    "Whether a keep claim holds the subject permanently",
  "settings.refMaintFactsRequestLeaseState":
    "Aggregate state of the subject's request leases: none, dormant, active, or expired",
  "settings.refMaintFactsRequestLeaseExpiresAt":
    "When the last live lease on the subject runs out",
  "settings.refMaintFactsActiveRetentionClaims":
    "How many request leases still hold the subject",
  "settings.refMaintFactsListsAddedByList": "Whether a list, rather than a person, added the subject to the library",
  "settings.refMaintFactsListsOnEnabledList": "Whether any enabled list, public or personal, still lists the subject",
  "settings.refMaintFactsListsNames": "Names of the enabled public lists that still list the subject",
  "settings.refMaintFactsListsLeftAll": "Whether every list that ever listed the subject has dropped it",
  "settings.refMaintFactsListsLeftAt": "When the last list dropped the subject",
  "settings.refMaintFactsListsLastListName": "The public list the subject most recently left",
  ...
  "settings.refMaintFactsEpisodePositionByAirDateValue": "Rank 1 is the newest eligible downloaded, aired non-special episode. Equal air dates use season and episode numbers, then stable IDs.",
  "settings.refMaintFactsSeasonPositionByAirDateValue": "Rank 1 is the season with the newest eligible downloaded, aired non-special episode. Protected files still occupy a rank.",
  "settings.refMaintFactsStorageRootIdValue": "Durable configured library-root identifier selected on this revision",
  "settings.refMaintFactsStorageAvailableBytesValue": "Available capacity in bytes, observed from the selected root itself",
  "settings.refMaintFactsStorageTotalBytesValue": "Total capacity in bytes, observed from the selected root itself",
  "settings.refMaintFactsStorageAvailablePercentValue": "Available capacity divided by total capacity, from 0 to 100",
  "settings.refMaintFactsActiveDownloadsValue": "True when a download for the subject is in flight",
  "settings.refMaintFactsWatchedByUserIdsValue": "Identifiers of everyone who played it, sorted and deduplicated; an empty list means nobody has. Season completion requires the same person to have watched every aired episode, including missing files. Future episodes are excluded; missing episode history or unresolved air dates are unknown. Watch facts are unknown for title-scoped shows (show_watch_rollup_unavailable), when no media server is connected (no_media_server_connection), when a connection has never synced cleanly (signal_sync_never_succeeded), when the last clean sync is over 48 hours old (signals_stale), when nobody holds a verified linked media-server account (no_linked_participants), and when a play cannot be attributed to a Scryer user (signal_identity_missing).",
  ...
  "settings.refMaintFactsKeepClaimActiveValue":
    "True when a request was approved forever, or an administrator pinned the subject. Every claim fact is unknown with reason claim_store_unreadable when the claim store could not be read for the pass.",
  "settings.refMaintFactsRequestLeaseStateValue":
    "none when no request lease was ever written for the subject, dormant when a lease is waiting for the first import, active while a lease is running, and expired once every lease has run out. A lease that was released or converted is withdrawn rather than spent, so it does not make the state expired. Expiry is measured against the evaluation time, so a lease reads as expired the moment its window closes.",
  "settings.refMaintFactsRequestLeaseExpiresAtValue":
    "RFC3339 timestamp of the latest expiry among the live leases; absent with reason no_live_lease when nothing is holding the subject",
  "settings.refMaintFactsActiveRetentionClaimsValue":
    "Count of leases still holding the subject, dormant ones included",
  "settings.refMaintFactsListsAddedByListValue": "True when a list sync created the title; unknown with reason list_store_unreadable when the list store could not be read",
  "settings.refMaintFactsListsOnEnabledListValue": "True while at least one enabled list holds the subject",
  "settings.refMaintFactsListsNamesValue": "Public list names only, sorted; a member's personal list is never named",
  "settings.refMaintFactsListsLeftAllValue": "True once every list that listed the subject has dropped it; false while one still holds it or when no list ever did",
  "settings.refMaintFactsListsLeftAtValue": "RFC3339 timestamp; absent with reason not_left_every_list while any list still holds the subject",
  "settings.refMaintFactsListsLastListNameValue": "Name of that public list; absent with reason no_public_list_left when the subject never left a public list",
  ...
  "settings.refMaintFileIs3d": "True when media metadata declares 3D video. False means not detected, including files not yet analyzed.",
  ...
  "settings.maintenanceTemplateExpiredLeasesTitle": "Expired request leases",
  "settings.maintenanceTemplateExpiredLeasesDescription":
    "Caution: this template deletes the title and its files. It matches titles whose request leases have all run out and that carry no keep claim, after a 7-day grace period. A lease that has not started yet — the title has not been imported — and a title anyone pinned to keep are both left alone.",
  ...
  "settings.maintenanceTemplateNewestEpisodesTitle": "Keep newest 3 downloaded episodes",
  "settings.maintenanceTemplateNewestEpisodesDescription":
    "Caution: this episode-scoped template unmonitors and deletes downloaded episodes ranked older than the newest three by air date. Specials, future episodes, missing files, and unresolved dates receive no rank, so they do not match. Protected episodes still occupy the newest-three slots.",
  "settings.maintenanceTemplateNewestSeasonsTitle": "Keep newest 2 downloaded seasons",
  "settings.maintenanceTemplateNewestSeasonsDescription":
    "Caution: this season-scoped template unmonitors and deletes files from seasons ranked older than the newest two by each season's newest eligible downloaded episode. Specials, future episodes, missing files, and unresolved dates receive no rank; protected seasons still occupy slots.",

  // ── Request rules ───────────────────────────────────────────────────
  "settings.requestRules": "Request Rules",
  "settings.noRequestRulesFound": "No request rules yet.",
  "settings.requestRuleMode": "Mode",
  "settings.requestRuleModeDisabled": "Disabled",
  "settings.requestRuleModeShadow": "Shadow",
  "settings.requestRuleModeEnforce": "Enforce",
  "settings.requestRuleModeDisabledHelp": "Never runs.",
  "settings.requestRuleModeShadowHelp": "Records what it would decide. Nothing happens to the request.",
  "settings.requestRuleModeEnforceHelp": "Its verdict resolves the request: approved, denied, or sent for review.",
  "settings.requestRuleModeHelp":
    "A rule only acts when three things agree: this mode says Enforce, the instance gate below is on, and the requester has permission to request from the library. Anything less and the rule still records what it would have done.",
  "settings.requestRuleLibraries": "Libraries",
  "settings.requestRuleLibrariesAll": "All libraries",
  "settings.requestRuleLibrariesHelp": "Leave every box unticked to apply this rule to requests in every library.",
  "settings.requestRuleRevision": "Revision",
  "settings.requestRuleDecisionCount": "Decisions",
  "settings.requestRuleCopy": "Copy rule",
  "settings.requestRuleCreate": "Create rule",
  "settings.requestRuleUpdate": "Update rule",
  "settings.requestRuleCreateNew": "New request rule",
  "settings.requestRuleCreated": "Request rule created. It is disabled until you arm it.",
  "settings.requestRuleUpdated": "Request rule updated.",
  "settings.requestRuleDeleted": "Deleted request rule {{name}}.",
  "settings.requestRuleDeleting": "Delete the request rule {{name}}? Its recorded decisions are kept.",
  "settings.requestRuleModeUpdated": "Changed the mode of {{name}}.",
  "settings.requestRuleValidationRequired": "A request rule needs a name and a matcher.",
  "settings.requestRuleSaveDisabledNote":
    "Saving stores the rule disabled. Arming it is a separate step, and the instance gate has to be on as well.",
  "settings.requestRuleConfirmDiscardTitle": "Discard unsaved changes?",
  "settings.requestRuleConfirmDiscardDescription":
    "The matcher in the editor has not been saved. Continuing replaces it.",
  "settings.requestRuleRequesters": "Name people in this rule",
  "settings.requestRuleRequestersHelp":
    "Tick the accounts this rule is about and apply them. The matcher in the editor is rewritten so you can read it before saving.",
  "settings.requestRuleRequestersApply": "Write these names into the matcher",
  "settings.requestRuleRequestersUnavailable":
    "Listing accounts needs permission this page does not carry, so names have to be typed into the matcher by hand.",
  "settings.requestRuleRequestersNoTarget":
    "This matcher does not name anybody, so there is nowhere to write the accounts you picked. Add a requesters set or a username comparison first.",

  "settings.requestRulesStatusGateClosedTitle": "Nothing is being decided automatically",
  "settings.requestRulesStatusGateClosedBody":
    "The instance gate is off, so every request still waits for a person. Rules you arm here will record what they would have decided.",
  "settings.requestRulesStatusIdleTitle": "The gate is open and no rule is armed",
  "settings.requestRulesStatusIdleBody":
    "Requests take the ordinary path until at least one rule is set to Shadow or Enforce.",
  "settings.requestRulesStatusShadowingTitle": "Rules are recording, not acting",
  "settings.requestRulesStatusShadowingBody":
    "Every armed rule is in Shadow, so their verdicts are written to the decision trace and nothing happens to the request.",
  "settings.requestRulesStatusEnforcingTitle": "Requests are being resolved automatically",
  "settings.requestRulesStatusEnforcingBody":
    "At least one rule is enforcing, so requests it matches are approved or denied without a person seeing them.",

  "settings.requestGateTitle": "Instance gate",
  "settings.requestGateSubtitle":
    "The instance-wide switch that lets any request rule act. It is separate from each rule's mode, and it is kept behind a different permission.",
  "settings.requestGateEvaluation": "Evaluate request rules",
  "settings.requestGateEvaluationHelp":
    "With this off, no rule resolves a request, however it is armed. Rules still record what they would have decided.",
  "settings.requestGateLocked":
    "Changing the instance gate needs system-settings management, which this account does not have. Rule modes above are yours to set.",
  "settings.requestGateUpdated": "Instance gate updated.",

  "settings.requestPreviewTitle": "Try this rule against a request",
  "settings.requestPreviewSubtitle":
    "Runs one matcher against a request you describe. Nothing is submitted and nothing is recorded.",
  "settings.requestPreviewSource": "Matcher",
  "settings.requestPreviewSourceStored": "A saved rule",
  "settings.requestPreviewSourceDraft": "The editor draft",
  "settings.requestPreviewRuleSelect": "Rule",
  "settings.requestPreviewRuleSelectPlaceholder": "Choose a rule",
  "settings.requestPreviewUser": "Requester",
  "settings.requestPreviewUserPlaceholder": "Choose an account",
  "settings.requestPreviewLibrary": "Library",
  "settings.requestPreviewLibraryPlaceholder": "Choose a library",
  "settings.requestPreviewProfile": "Quality profile",
  "settings.requestPreviewProfilePlaceholder": "Choose a profile",
  "settings.requestPreviewMonitor": "Monitoring",
  "settings.requestPreviewLease": "Keep for",
  "settings.requestPreviewLeaseDays": "Days",
  "settings.requestPreviewMedia": "Media",
  "settings.requestPreviewMediaPlaceholder": "Search for a title",
  "settings.requestPreviewMediaSelected": "Using {{title}}.",
  "settings.requestPreviewRun": "Run preview",
  "settings.requestPreviewRunning": "Running…",
  "settings.requestPreviewEmpty": "Describe a request and run the preview to see what this rule would say.",
  "settings.requestPreviewMetadataPartial": "Metadata incomplete",
  ...
  "settings.requestDecisionsSubtitle":
    "What request rules have decided lately, including the verdicts shadow rules only recorded.",
  "settings.requestDecisionsOutcomeFilter": "Outcome",
  "settings.requestDecisionsOutcomeAll": "Any outcome",
  "settings.requestDecisionsColTime": "Evaluated",
  "settings.requestDecisionsColOutcome": "Outcome",
  "settings.requestDecisionsColMode": "Mode",
  "settings.requestDecisionsColVotes": "Votes",
  "settings.requestDecisionsColReasons": "Reasons",
  "settings.requestDecisionsEmpty": "No decisions recorded yet.",
  "settings.requestDecisionsPolicySaid": "The rules said {{outcome}}.",
  "settings.requestDecisionNoVotes": "No rule voted.",
  "settings.requestDecisionHeld": "held",
  ...
  "settings.requestTemplateNamedRequestersDescription":
    "Approves requests from three named people when the certification is family-rated, and tags the most family-friendly of them. The names are placeholders: use the account picker to replace them before saving.",
  "settings.requestTemplateShortLeaseTitle": "Short leases from one person",
  "settings.requestTemplateShortLeaseDescription":
    "Approves one named person's requests when they ask to keep the media for two weeks or less. A request to keep it forever carries no day count, so it is not approved here.",
  "settings.requestTemplateLowResolutionTitle": "Low-resolution requests",
  "settings.requestTemplateLowResolutionDescription":
    "Approves one named person's requests when the quality profile they chose tops out at 720p or below.",
  "settings.requestTemplateDenyAdultTitle": "Deny adult content",
  "settings.requestTemplateDenyAdultDescription":
    "Denies any request for media the metadata marks as adult, and records why. Names nobody, so it applies to every requester.",
  "settings.requestTemplateMonthlyQuotaTitle": "Monthly approval quota",
  "settings.requestTemplateMonthlyQuotaDescription":
    "Sends a request for review once the requester has had five approved in the last thirty days. It never denies; it asks a person to look.",

  "settings.refReqTitle": "Request input reference",
  "settings.refReqSubtitle": "Every value a request matcher can read, and what each one means.",
  "settings.refReqIntro":
    "A request rule reads one document describing the request, the person who made it, the library it targets, and what Scryer knows about the media. Facts are plain values. A fact Scryer could not observe is simply missing, and a rule that reads a missing fact holds the request for a person instead of guessing — you never write that guard yourself.",
  "settings.refReqOutputTitle": "What a request rule defines",
  "settings.refReqOutputIntro":
    "At least one of these has to be defined, or the rule can never vote and Scryer refuses to save it.",
  "settings.refReqOutputApprove": "approve — the request may be granted without a person seeing it.",
  "settings.refReqOutputDeny": "deny — the request is refused. A denial beats every other vote.",
  "settings.refReqOutputManual": "manual — the request goes to a person, whatever else voted.",
  "settings.refReqOutputTags": "tags contains \"…\" — labels for the media, applied only on an approval.",
  "settings.refReqOutputReasons": "reasons contains \"…\" — stable codes the requester is shown.",
  "settings.refReqOutputNoPackage":
    "Do not write a package or import line. Scryer generates both and strips them back off when it hands the matcher to this editor.",

  // ── Request leases, decisions and claims ────────────────────────────
  "search.keepFor": "Keep for",
  "search.keepForForever": "Forever",
  "search.keepForDays": "{{count}} days",
  "search.keepForCustom": "A number of days…",
  "search.keepForCustomLabel": "Days to keep",
  "search.keepForHelp":
    "How long Scryer holds this media for you. When the time is up a maintenance rule may remove it; keeping it forever never expires.",

  "requests.preflightAutoApprove": "This will be approved automatically",
  "requests.preflightManualReview": "This needs approval",
  "requests.preflightDeny": "This would be denied: {{reasons}}",
  "requests.preflightTags": "It will be tagged {{tags}}.",
  "requests.preflightReason": "Reason: {{reason}}.",
  "requests.preflightMetadataPartial":
    "Scryer could not read everything about this title, so a person will decide.",
  "requests.preflightPreviewOnly": "preview only",

  "requests.leaseForever": "Kept forever",
  "requests.leaseRequested": "Asked for {{count}} days",
  "requests.leaseDormant": "{{count}} days from first import",
  "requests.leaseActive": "Kept until {{date}}",
  "requests.leaseExpired": "Lease expired",
  "requests.leaseReleased": "Lease released",

  "requests.decisionTitle": "How this was decided",
  "requests.decisionShadow": "recorded only",
  "requests.decisionPolicySaid": "The rules said {{outcome}}; something else decided the request.",
  "requests.decisionVotes": "Rule votes",
  "requests.decisionNothingToShow": "No rule had anything to say about this request.",
  "requests.decisionOutcomeAutoApprove": "Approved by rule",
  "requests.decisionOutcomeManualReview": "Sent for review",
  "requests.decisionOutcomeDeny": "Denied by rule",
  "requests.denyReason": "Denied because: {{reasons}}",
  "requests.policyTagsLabel": "Would be tagged",

  "requests.voteApprove": "approve",
  "requests.voteDeny": "deny",
  "requests.voteManual": "review",
  "requests.voteAbstain": "no opinion",
  "requests.voteNone": "no vote",

  "requests.fallbackRuleManual": "A rule asked for a person to look at this.",
  ...
  "requests.claimsEmpty": "Nothing is holding this title.",
  "requests.claimKindKeep": "Held permanently",
  "requests.claimExpiresAt": "Held until {{date}}",
  "requests.claimDurationDays": "{{count}} days, starting at the first import",
  "requests.claimReleasedReason": "Released: {{reason}}",
  "requests.claimStateDormant": "Waiting for import",
  "requests.claimStateActive": "Holding",
  "requests.claimStateExpired": "Expired",
  "requests.claimStateReleased": "Released",
  "requests.claimStateConverted": "Replaced",
  "requests.claimExtend": "Extend",
  "requests.claimExtendTitle": "Extend this hold",
  "requests.claimExtendUntil": "Hold until",
  "requests.claimMakePermanent": "Keep permanently",
  "requests.claimRelease": "Release",
  "requests.claimReleaseTitle": "Release this hold",
  "requests.claimReleaseReason": "Reason",
  "requests.claimReleaseReasonPlaceholder": "Why this hold is being lifted",
  "requests.claimReleaseReasonHelp": "A reason is required; it is recorded against the hold.",

  "status.requestApprovedClaimFailed":
    "Approved {{name}}, but nothing is holding it: {{error}}",
  "status.claimExtended": "Hold extended.",
  "status.claimMadePermanent": "The title is now held permanently.",
  "status.claimReleased": "Hold released.",

  // ── Request rules context reference ─────────────────────────────────
  "settings.refReqSectionInput": "— The request being decided",
  "settings.refReqInputSchemaVersion": "Version of this document's shape; it only changes when fields are added",
  "settings.refReqInputEvaluationTime": "RFC3339 timestamp the request was evaluated at",
  "settings.refReqSectionNow": "— The clock at evaluation time, for rules that depend on when a request arrives",
  "settings.refReqNowWeekday": "Day of the week in UTC, lowercase and in English (monday … sunday)",
  "settings.refReqNowHourUtc": "Hour of the day in UTC, 0 to 23",
  "settings.refReqSectionRequester": "— The person who made the request. A matcher that reads any of these needs permission-management authority to save",
  "settings.refReqRequesterUserId": "Identifier of the requesting account",
  "settings.refReqRequesterUsername": "Username of the requesting account",
  "settings.refReqRequesterAccountKind": "How the account signs in (for example local, or a linked provider)",
  "settings.refReqRequesterAppPermissions": "Application-wide permissions the account holds",
  "settings.refReqRequesterLibraryPermissions": "Permissions the account holds on the library being requested from",
  "settings.refReqRequesterLinkedProviders": "Media-server and identity providers the account has linked",
  "settings.refReqRequesterCreatedAt": "When the account was created; absent, because Scryer does not record it yet",
  "settings.refReqSectionLibrary": "— The library the request targets",
  "settings.refReqLibraryId": "Identifier of the library",
  "settings.refReqLibraryName": "Name of the library",
  "settings.refReqLibraryFacet": "Kind of media the library holds (MOVIE, SERIES or ANIME)",
  "settings.refReqLibraryIsDefault": "True when this is the default library for its kind",
  "settings.refReqSectionRequest": "— What was asked for",
  "settings.refReqRequestOrigin": "Where the request came from (for example the search dialog)",
  "settings.refReqRequestTitle": "Title as it read at request time",
  "settings.refReqRequestYear": "Release year, when the provider knew one",
  "settings.refReqRequestExternalIds": "Provider identifiers; see input.request.external_ids below",
  "settings.refReqRequestQualityProfileId": "Identifier of the quality profile the requester chose",
  "settings.refReqRequestQualityProfileName": "Name of that profile",
  "settings.refReqRequestMonitorType": "Monitoring the requester asked for (for example ALL_EPISODES)",
  "settings.refReqRequestMonitorSelectionSeasonCount": "How many seasons an advanced monitoring selection named",
  "settings.refReqRequestLeaseForever": "True when the requester asked to keep the media forever",
  "settings.refReqRequestLeaseDays": "How many days the requester asked to keep it for; absent when they asked for forever",
  "settings.refReqSectionExternalIds": "— Provider identifiers on input.request.external_ids",
  "settings.refReqExternalIdsTmdb": "TMDB identifier, when the provider had one",
  "settings.refReqExternalIdsImdb": "IMDb identifier, when the provider had one",
  "settings.refReqExternalIdsTvdb": "TVDB identifier, when the provider had one",
  "settings.refReqSectionFacts": "— What Scryer knows about the media and about this requester's history. A fact Scryer could not observe is missing, and reading a missing fact holds the request for a person",
  "settings.refReqFactsAgeRating": "Minimum age the certification implies",
  "settings.refReqFactsCertifications": "Every certification the metadata carries; see input.facts.certifications[] below",
  "settings.refReqFactsCertificationLabel": "US certification label (for example G, PG, PG-13, R)",
  "settings.refReqFactsCertificationRank": "That label as a number, lowest first, so rules can compare rather than list labels",
  "settings.refReqFactsCommonsenseRecommended": "Whether Common Sense Media recommends the title for its age band",
  "settings.refReqFactsGenres": "Genre names on the title",
  "settings.refReqFactsCanonicalTagKeys": "Scryer's canonical tag keys for the title",
  "settings.refReqFactsThemes": "Theme names on the title",
  "settings.refReqFactsIsAdult": "Whether the metadata marks the title as adult",
  "settings.refReqFactsRating": "Combined metadata rating",
  "settings.refReqFactsRatingsBySource": "The same ratings keyed by the source that gave them",
  "settings.refReqFactsTmdbVoteAverage": "TMDB's average vote",
  "settings.refReqFactsTmdbVoteCount": "How many votes that average is made of",
  "settings.refReqFactsPopularity": "Provider popularity score",
  "settings.refReqFactsRuntimeMinutes": "Runtime in minutes",
  "settings.refReqFactsOriginalLanguage": "Original language code",
  "settings.refReqFactsCountry": "Country of origin",
  "settings.refReqFactsNetwork": "Network that aired it",
  "settings.refReqFactsStudio": "Studio that made it",
  "settings.refReqFactsContentStatus": "Provider content status (for example Continuing, Ended)",
  "settings.refReqFactsReleaseDate": "Release date, for movies",
  "settings.refReqFactsFirstAired": "First air date, for series",
  "settings.refReqFactsReleaseAgeDays": "How many days ago it was released or first aired",
  "settings.refReqFactsAwardCount": "How many awards the metadata records",
  "settings.refReqFactsQualityProfileTiers": "Tier names in the quality profile the requester chose",
  "settings.refReqFactsQualityProfileMaxResolution": "Highest vertical resolution that profile allows, in pixels",
  "settings.refReqFactsQualityProfileAllowsUpgrades": "Whether that profile keeps upgrading after a first grab",
  "settings.refReqFactsExistsInLibraryIds": "Libraries that already hold this title",
  "settings.refReqFactsPreviousRequestCount": "How many times this requester has asked for this title before",
  "settings.refReqFactsPreviouslyDenied": "Whether one of those earlier requests was denied",
  "settings.refReqFactsPreviouslyApproved": "Whether one of those earlier requests was approved",
  "settings.refReqFactsPendingRequestCount": "How many of this requester's requests are still waiting",
  "settings.refReqFactsApprovedLast30d": "How many of this requester's requests were approved in the last thirty days",
  "settings.refReqFactsDeniedLast30d": "How many were denied in the last thirty days",
  "settings.refReqFactsTotalApproved": "How many of this requester's requests have ever been approved",
  "settings.refReqFactsActiveLeaseCount": "How many titles this requester currently holds a lease on",
  "settings.refReqFactsDaysSinceLastRequest": "Days since this requester last asked for anything",
  "settings.refReqFactsLibraryTitleCount": "How many titles the target library holds",
  "settings.refReqSectionCertifications": "— One entry per certification in input.facts.certifications",
  "settings.refReqCertCountry": "Country the certification was issued in",
  "settings.refReqCertValue": "The certification itself (for example PG-13)",
  "settings.refReqCertSource": "Where the certification came from",
  "settings.refReqSectionObservations": "— The same facts as full envelopes, for rules that need to tell absent apart from unknown or to read the reason. Reading a fact here opts that fact out of the automatic hold: you are taking responsibility for the three-valued answer.",
  "settings.refReqObsStatus": "known, absent, or unknown. absent means the source answered and there is no value; unknown means Scryer could not find out. Test this before reading value — an unknown fact is never coerced to false, 0, or an empty string.",
  "settings.refReqObsObservedAt": "When the value was observed, if the source recorded a time",
  "settings.refReqObsReason": "Stable machine code explaining why the fact is unknown, or why an absent fact has no value",
  "settings.refReqSectionObsCertifications": "— One entry per certification in input.observations.certifications.value",
  "settings.refReqFactsAgeRatingValue": "Minimum age implied by the certification; absent with reason no_certification when the metadata carries none",
  "settings.refReqFactsCertificationsValue": "One entry per certification; see input.observations.certifications.value[] below",
  "settings.refReqFactsCertificationLabelValue": "The US certification label; absent when the metadata carries no US certification",
  "settings.refReqFactsCertificationRankValue": "That label as a number, lowest first; absent when the label is one Scryer does not rank",
  "settings.refReqFactsCommonsenseRecommendedValue": "True when Common Sense Media recommends the title for its age band",
  "settings.refReqFactsGenresValue": "Genre names, deduplicated; an empty list when the metadata names none",
  "settings.refReqFactsCanonicalTagKeysValue": "Canonical tag keys, deduplicated",
  "settings.refReqFactsThemesValue": "Theme names, deduplicated",
  "settings.refReqFactsIsAdultValue": "True when the metadata marks the title as adult",
  "settings.refReqFactsRatingValue": "The combined rating as a number",
  "settings.refReqFactsRatingsBySourceValue": "An object keyed by source name, each value that source's rating",
  "settings.refReqFactsTmdbVoteAverageValue": "TMDB's average vote as a number",
  "settings.refReqFactsTmdbVoteCountValue": "How many votes that average is made of",
  "settings.refReqFactsPopularityValue": "The popularity score as a number",
  "settings.refReqFactsRuntimeMinutesValue": "Runtime in whole minutes",
  "settings.refReqFactsOriginalLanguageValue": "Original language as a code",
  "settings.refReqFactsCountryValue": "Country of origin",
  "settings.refReqFactsNetworkValue": "Name of the network",
  "settings.refReqFactsStudioValue": "Name of the studio",
  "settings.refReqFactsContentStatusValue": "The provider's content status string",
  "settings.refReqFactsReleaseDateValue": "RFC3339 release date",
  "settings.refReqFactsFirstAiredValue": "RFC3339 first air date",
  "settings.refReqFactsReleaseAgeDaysValue": "Whole days since release or first airing",
  "settings.refReqFactsAwardCountValue": "Number of awards recorded; a confirmed zero when there are none",
  "settings.refReqFactsQualityProfileTiersValue": "Tier names in the chosen profile, in profile order",
  "settings.refReqFactsQualityProfileMaxResolutionValue": "Highest vertical resolution the profile allows, in pixels",
  "settings.refReqFactsQualityProfileAllowsUpgradesValue": "True when the profile keeps upgrading after a first grab",
  "settings.refReqFactsExistsInLibraryIdsValue": "Identifiers of libraries already holding the title; an empty list when none do",
  "settings.refReqFactsPreviousRequestCountValue": "Number of earlier requests by this requester for this title",
  "settings.refReqFactsPreviouslyDeniedValue": "True when one of those earlier requests was denied",
  "settings.refReqFactsPreviouslyApprovedValue": "True when one of those earlier requests was approved",
  "settings.refReqFactsPendingRequestCountValue": "Number of this requester's requests still waiting on a decision",
  "settings.refReqFactsApprovedLast30dValue": "Number approved in the last thirty days, measured against the evaluation time",
  "settings.refReqFactsDeniedLast30dValue": "Number denied in the last thirty days, measured against the evaluation time",
  "settings.refReqFactsTotalApprovedValue": "Number of this requester's requests ever approved",
  "settings.refReqFactsActiveLeaseCountValue": "Number of titles this requester currently holds a lease on, dormant leases included",
  "settings.refReqFactsDaysSinceLastRequestValue": "Whole days since the requester's previous request; absent with reason no_previous_request when this is their first",
  "settings.refReqFactsLibraryTitleCountValue": "Number of titles in the target library",

  "move.dialogTitle": "Move titles",
  "move.dialogDescription": "Review the plan for {{count}} selected title(s) before anything moves.",
  ...
  "move.modeHelp.MOVE_WITH_SCRYER": "Scryer moves or copies the files and verifies every one before the catalog changes.",
  "move.modeHelp.FILES_ALREADY_THERE": "Scryer scans the destination and adopts the files you moved yourself.",
  "move.catalogOnlyFastPath": "These titles have no files on disk, so this is a catalog-only reassignment: nothing moves and no mode is needed.",
  "move.selectDestinationPrompt": "Choose a destination root to see the plan.",
  "move.previewLoading": "Gathering all the info...",
  "move.gatheringInfo": "Gathering all the info...",
  "move.methodManaged": "Scryer moves files",
  "move.methodManual": "I'll move the files",
  "move.manualLoading": "Loading folder instructions...",
  "move.manualInstructions": "Move the files, then come back and click Next.",
  "move.changeDestination": "Change destination",
  "move.manualMappingChanged": "Catalog locations changed. Review the updated folders before clicking Next again.",
  "move.manualStructure": "Use the destination folders below, preserving filenames and relative directories. Next updates the catalog and trusts that you moved the files; Scryer will not check or change them.",
  "move.manualSource": "Current folder",
  "move.manualDestination": "Move to folder",
  "move.retryInstructions": "Reload instructions",
  "move.previewFailed": "Failed to preview the move.",
  "move.planChanged": "The plan changed since you previewed it. Review the fresh plan before confirming.",
  "move.rePreview": "Preview again",
  "move.summaryTitles": "Titles",
  "move.summaryFiles": "Files",
  "move.summarySize": "Total size",
  "move.sampledItems": "sample",
  "move.blockedHeading": "{{count}} title(s) cannot move yet",
  "move.blockedHelp": "Deselect them to move the rest, or wait for their work to finish.",
  "move.deselect": "Deselect",
  "move.deselectedCount": "{{count}} title(s) removed from this move.",
  "move.restoreSelection": "Restore selection",
  "move.titleFileSummary": "{{files}} file(s) · {{size}}",
  ...
  "move.verificationStatementQuick": "All {{files}} file(s) ({{bytes}}) will be checked against their head, tail, and size.",
  "move.verificationNotApplicable": "No files move, so nothing needs verifying.",
  "move.verificationStampFull": "verified (full)",
  "move.verificationStampQuick": "verified (quick)",
  "move.verificationFallbackCount": "{{count}} file(s) fell back to the quick check",
  "move.typedConfirmationPrompt": "Type the phrase to confirm",
  "move.confirm": "Start move",
  "move.startFailed": "Failed to start the move.",
  "move.operationLoading": "Loading the operation…",
  "move.operationLoadFailed": "Failed to load the operation.",
  ...
  "move.counterUnresolved": "Unresolved",
  ...
  "move.transferShowMore": "Show more",
  ...
  "move.transferFileState.COMPARING": "Comparing files",
  "move.transferFileState.DONE": "Done",
  "move.transferFileState.FAILED": "Error",
  "move.transferFileState.BLOCKED": "Blocked",
  "move.transferFileState.CANCELED": "Canceled",
  "move.transferFileState.NOT_PROCESSED": "Not processed",
  "move.transferShowLess": "Show less",
  "move.transferOverallProgress": "Overall progress",
  "move.transferEstimating": "Estimating…",
  "move.transferDisconnected": "Reconnecting…",
  "move.transferEta": "About {{minutes}} min remaining",
  "move.transferColumnTitle": "Title",
  "move.transferColumnStatus": "Status",
  "move.transferColumnFiles": "Files done/total",
  "move.transferColumnCurrentFile": "Current file",
  "move.transferColumnProgress": "Progress",
  "move.transferRange": "{{from}}–{{to}} of {{total}}",
  "move.transferPrevious": "Previous",
  "move.transferNext": "Next",
  "move.transferException": "Show exception for {{title}}",
  "move.transferActive": "{{copying}} moving · {{verifying}} verifying",
  "move.transferDetailPending": "No further details available.",
  ...
  "move.assetsHeading": "Renamed and deduplicated files",
  "move.assetRenamedAs": "{{from}} → {{to}}",
  "move.assetDeduplicatedAgainst": "{{from}} deduplicated against {{to}}",
  "move.assetUnknownCounterpart": "an unnamed file",
  "move.assetProvenance": "(from {{library}})",
  "move.assetStateDone": "Done",
  "move.assetStatePlanned": "Planned",
  "move.cancelAction": "Cancel operation",
  "move.cancelRequested": "Cancellation requested; finishing in-flight work safely.",
  "move.cancelNotPossible": "This operation has already finished.",
  "move.cancelFailed": "Failed to request cancellation.",
  "move.cancelDraining": "Finishing in-flight work",
  "move.resumeAction": "Resume",
  ...
  "move.class.NO_OP": "Already at the destination",
  "move.class.NEEDS_RESOLUTION": "Needs a decision",
  "move.class.INCOMPATIBLE": "Cannot go there",
  ...
  "move.planKind.BLOCKED": "Blocked",
  "move.planKind.UNMANAGED_CONTENT": "Unmanaged content",
  "move.planKind.WARNING": "Warnings",
  "move.operationState.QUEUED": "Queued",
  "move.operationState.PREPARING": "Preparing",
  "move.operationState.MOVING": "Moving",
  "move.operationState.VERIFYING": "Verifying",
  "move.transferDismiss": "Dismiss",
  "move.operationState.RECONCILING": "Finalizing",
  "move.operationState.CLEANING_UP": "Finalizing",
  "move.operationState.COMPLETED": "Completed",
  "move.operationState.COMPLETED_WITH_WARNINGS": "Completed with warnings",
  "move.operationState.CANCELED": "Canceled",
  "move.operationState.FAILED": "Failed",
  "move.checkpointState.PENDING": "Pending",
  "move.checkpointState.MOVING": "Moving",
  "move.checkpointState.VERIFYING": "Verifying",
  "move.checkpointState.RECONCILING": "Finalizing",
  "move.checkpointState.CLEANING_UP": "Finalizing",
  "move.checkpointState.COMPLETED": "Completed",
  "move.checkpointState.COMPLETED_WITH_WARNINGS": "Completed with warnings",
  "move.checkpointState.SKIPPED": "Skipped",
  "move.checkpointState.BLOCKED": "Blocked",
  "move.checkpointState.FAILED": "Failed",
  "move.operationType.FOLDER_REASSIGNMENT": "Folder reassignment",
  "move.operationType.ROOT_MOVE": "Root move",
  "move.operationType.ROOT_CHANGE": "Root change",
  ...
  "rootChange.unavailableWhileUnsaved": "Save or discard the pending root edits first.",
  "rootChange.dialogTitle": "Change root",
  "rootChange.dialogDescription": "Everything on {path} moves. A root-wide operation cannot leave a title behind.",
  "rootChange.destinationHeading": "Where this root goes",
  "rootChange.destinationNewPath": "A new path",
  "rootChange.destinationNewPathHelp": "The root keeps its identity and its title assignments; only its path changes.",
  "rootChange.destinationExistingRoot": "Another root of this library",
  ...
  "rootChange.preview": "Preview",
  "rootChange.confirm": "Start",
  "rootChange.startFailed": "Failed to start this root change.",
  "rootChange.startedHeading": "The root change started. Follow it in Activity.",
  "rootChange.viewInActivity": "View in Activity",
  "rootChange.identityKeepsRoot": "This root keeps its identity and all {titles} of its title assignments.",
  "rootChange.identityKeepsDefault": "It stays this library's default root.",
  "rootChange.identityLosesDefault": "It is no longer this library's default root.",
  "rootChange.consolidationStatement": "All {titles} titles on this root move onto the root you picked.",
  "rootChange.consolidationRetiresConfiguration": "The source root's configuration is retired once everything has landed and all recycling has finished.",
  "rootChange.defaultTransfers": "The destination root becomes this library's default, so new content lands there.",
  "rootChange.defaultStays": "This library's default root does not change.",
  "rootChange.accountingHeading": "Every title on this root",
  "rootChange.accountingAssigned": "Assigned",
  "rootChange.accountingRelocating": "Moving",
  "rootChange.accountingCatalogOnly": "Catalog only",
  "rootChange.accountingBlocked": "Blocked",
  "rootChange.accountingDoesNotClose": "The counts do not add up to the total. Do not confirm this plan.",
  "rootChange.blockedTitlesHeading": "{count} titles cannot enter this operation.",
  "rootChange.blockedTitlesNoExclude": "Repair these before starting. A root-wide operation cannot leave a title behind.",
  "rootChange.groupsHeading": "What this consolidation does",
  "rootChange.group.movingIntoUnusedFolders": "Into free folders",
  ...
  "rootChange.renamedFoldersSampled": "Only the first folders are listed here.",
  "rootChange.contentHeading": "What is on this root",
  "rootChange.contentManaged": "Tracked media",
  "rootChange.contentCompanions": "Companion files",
  "rootChange.contentUnknown": "Unexplained",
  "rootChange.contentSampled": "Only the first entries are listed here.",
  "rootChange.unknownContentHelp": "{bytes} of content nothing tracks. It is never moved, never deleted, and it keeps the old location standing.",
  "rootChange.retirementHeading": "The old location afterwards",
  "rootChange.retirementEmptyDirectoriesOnly": "Only empty directories are removed: {count} of them.",
  "rootChange.retirementVerificationFirst": "Nothing at the source is removed before its destination copy is verified.",
  "rootChange.retirementRetainedHeading": "Left standing with their contents:",
  "rootChange.retirementBlockedHeading": "The old location stays until these are resolved:",
  "rootChange.retirementPermitted": "Nothing blocks the old location from being retired.",
  "rootChange.verificationStatement": "{files} files ({bytes}) are verified in full at the destination before any source is recycled.",
  "rootChange.insufficientSpace": "The destination does not have the {required} this needs.",
  "rootChange.typedConfirmationPrompt": "Type the phrase to confirm",
  "rootChange.reason.root_identity_retained": "The root keeps its identity; only its path changes.",
  "rootChange.reason.catalog_only_root_change": "No tracked files, so this is a catalog reassignment.",
  "rootChange.reason.title_blocked_for_root_change": "This title cannot enter the root change yet.",
  "rootChange.reason.unknown_root_content": "Content at the root that no title accounts for.",
  "rootChange.reason.source_retirement_blocked": "The old location cannot be retired yet.",
  "rootChange.reason.file_outside_title_folder": "A tracked file that sits outside its title's folder.",
  "rootChange.reason.hardlinked_source": "The source file has other hard links, which do not follow the move.",
  "rootChange.reason.roots_consolidated": "Every title on this root moves onto the destination root.",
  "rootChange.reason.default_root_transferred": "The destination root becomes this library's default.",
  "rootChange.reason.moves_into_unused_folder": "Moves into a folder nothing occupies.",
  "rootChange.reason.merges_with_destination_title": "Merges with a destination title it shares an identity with.",
  "rootChange.reason.folder_name_uniqued": "The folder name is taken at the destination, so this one is renamed.",
  "rootChange.reason.catalog_only_consolidation": "No tracked files, so this is a catalog reassignment.",
  "rootChange.reason.destination_folder_exists": "The destination folder already exists.",
  "rootChange.retirementBlocker.blocked_titles": "Some titles cannot enter the operation.",
  "rootChange.retirementBlocker.unexplained_source_content": "Content at the source that nothing accounts for.",
  "rootChange.refusal.root_change_path_not_absolute": "Give an absolute path.",
  "rootChange.refusal.root_change_paths_overlap": "The new path is inside the old one, or the other way round.",
  "rootChange.refusal.root_change_source_root_is_symlink": "This root is a symlink. Point it at the real directory first.",
  ...
  "rootChange.refusal.root_consolidation_mode_not_supported": "A consolidation always moves the files; \"files are already there\" is not offered here.",
  "indexerSearch.searchWithThisIndexer": "Search with this indexer",
  "indexerSearch.queryPlaceholder": "Search every indexer for a release…",
  "indexerSearch.kindLabel": "Kind",
  "indexerSearch.kind.movie": "Movie",
  "indexerSearch.kind.series": "Series",
  "indexerSearch.kind.anime": "Anime",
  "indexerSearch.kind.raw": "Raw",
  "indexerSearch.scope.indexers": "Indexers",
  "indexerSearch.scope.indexersAll": "All ({{count}})",
  "indexerSearch.scope.indexersSome": "{{count}} selected",
  "indexerSearch.scope.indexersAllOption": "All indexers",
  "indexerSearch.scope.categories": "Categories",
  "indexerSearch.scope.categoriesDefault": "All categories",
  "indexerSearch.scope.categoriesHelp":
    "Comma-separated Newznab category ids. Leave empty to use the defaults for the selected kind.",
  "indexerSearch.advanced": "Advanced",
  "indexerSearch.advanced.minSize": "Min size",
  "indexerSearch.advanced.maxSize": "Max size",
  "indexerSearch.advanced.minSeeders": "Min seeders",
  "indexerSearch.advanced.maxAge": "Max age",
  "indexerSearch.advanced.limit": "Result limit",
  "indexerSearch.unit.gib": "GiB",
  "indexerSearch.unit.days": "days",
  "indexerSearch.unit.perIndexer": "per indexer",
  "indexerSearch.saveSearch": "Saved",
  "indexerSearch.saveCurrentSearch": "Save current search",
  "indexerSearch.savedSearchesEmpty": "No saved searches yet.",
  "indexerSearch.health.releases": "{{count}} releases",
  "indexerSearch.health.indexers": "{{answered}}/{{total}} indexers",
  ...
  "indexerSearch.facet.resolution": "Resolution",
  "indexerSearch.facet.source": "Source",
  "indexerSearch.facet.audio": "Audio & HDR",
  "indexerSearch.facet.flags": "Flags",
  "indexerSearch.facet.indexer": "Indexer",
  "indexerSearch.facet.size": "Size",
  ...
  "indexerSearch.results.matched": "{{count}} shown",
  "indexerSearch.results.passing": "{{count}} accepted",
  "indexerSearch.sort.label": "Sort",
  "indexerSearch.sort.newest": "Newest",
  "indexerSearch.sort.size": "Size",
  "indexerSearch.sort.age": "Age",
  "indexerSearch.sort.seeders": "Seeders",
  "indexerSearch.sort.priority": "Indexer priority",
  "indexerSearch.column.release": "Release",
  "indexerSearch.column.indexer": "Indexer",
  "indexerSearch.column.size": "Size",
  "indexerSearch.column.age": "Age",
  "indexerSearch.column.peers": "Peers / Grabs",
  "indexerSearch.row.select": "Select release",
  "indexerSearch.row.grab": "Grab",
  "indexerSearch.row.download": "Download file",
  "indexerSearch.download.unavailable": "This release is a magnet link and has no file to download",
  "indexerSearch.row.expand": "Show details",
  "indexerSearch.row.collapse": "Hide details",
  "indexerSearch.row.priority": "Priority {{value}}",
  "indexerSearch.row.grabs": "{{count}} grabs",
  "indexerSearch.row.rejected": "Rejected · {{code}}",
  "indexerSearch.protocol.nzb": "NZB",
  "indexerSearch.protocol.torrent": "Torrent",
  "indexerSearch.detail.title": "Release detail",
  "indexerSearch.detail.publishDate": "Published",
  "indexerSearch.detail.releaseGroup": "Release group",
  "indexerSearch.detail.openOnIndexer": "Open on indexer",
  "indexerSearch.detail.notAvailable": "Not reported",
  "indexerSearch.age.hours": "{{count}} h",
  "indexerSearch.age.days": "{{count}} d",
  "indexerSearch.age.months": "{{count}} mo",
  "indexerSearch.age.years": "{{count}} y",
  "indexerSearch.footer.selected": "{{count}} selected",
  "indexerSearch.footer.nothingQueued": "Nothing is queued until you grab.",
  "indexerSearch.footer.grabSelected": "Grab selected",
  "indexerSearch.footer.downloadSelected": "Download {{count}}",
  ...
  "grabDialog.subtitle":
    "Send releases to a download client, with an optional library title assignment.",
  ...
  "grabDialog.assign.suggested": "Suggested titles",
  "grabDialog.routing.loading": "Resolving download clients…",
  "grabDialog.routing.single": "1 release",
  "grabDialog.routing.group": "{{count}} releases",
  "grabDialog.category": "Category",
  "grabDialog.category.default": "Client default",
  "grabDialog.footer.partial": "{{count}} submitted",
  "grabDialog.cta.grab": "Grab",
  ...
  "grabDialog.footer.linked": "Selected title: {{name}}",
  ...
  "lists.action.enabled": "Follow {{name}}",
  "lists.action.retry": "Try again",
  "lists.action.syncAll": "Sync all",
  "lists.action.syncNow": "Sync now",
  "lists.action.unfollow": "Unfollow",
  "lists.url.label": "Follow a list by URL",
  "lists.url.placeholder": "Paste a list or chart URL",
  "lists.url.submit": "Check list",
  "lists.url.help": "Paste the address of a list from a supported provider.",
  "lists.url.recognized": "{{provider}} · {{list}}",
  "lists.url.unrecognized": "This address isn't a list Scryer can follow. Check the provider catalog below for supported lists.",
  "lists.followed.heading": "Followed lists",
  "lists.followed.empty": "No public lists are being followed yet.",
  ...
  "lists.catalog.heading": "Browse lists",
  "lists.catalog.providers": "List providers",
  "lists.catalog.empty": "No list providers are installed.",
  "lists.catalog.follow": "Follow",
  "lists.catalog.every": "Syncs every {{interval}}",
  "lists.catalog.auth.noAccount": "No account needed",
  ...
  "lists.interval.hours": "{{count}} h",
  "lists.interval.days": "{{count}} d",
  "lists.kind.movie": "Movies",
  "lists.kind.series": "Series",
  "lists.kind.anime": "Anime",
  "lists.mode.search": "Add and search",
  "lists.mode.add": "Add only",
  "lists.mode.hold": "Hold for approval",
  "lists.mode.request": "Request",
  "lists.mode.discover": "Only show in Discover",
  "lists.modeHelp.search": "Adds new titles monitored and searches for them right away.",
  "lists.modeHelp.add": "Adds new titles monitored without searching.",
  "lists.modeHelp.hold": "Creates a pending request for each new title so someone can approve it.",
  "lists.modeHelp.request": "Requests new titles for a member.",
  "lists.modeHelp.discover": "Records the list's titles without adding anything.",
  "lists.mode.discoverUnavailable": "Available once lists appear in Discover.",
  "lists.onLeave.keep": "Keep the title",
  "lists.onLeave.log": "Log it",
  "lists.onLeave.unmonitor": "Unmonitor the title",
  "lists.onLeave.tag": "Tag the title",
  "lists.syncState.ok": "Synced",
  "lists.syncState.new": "Not synced yet",
  "lists.syncState.fail": "Sync failed",
  "lists.syncState.off": "Paused",
  "lists.membershipState.inLibrary": "In library",
  "lists.membershipState.added": "Added",
  "lists.membershipState.requested": "Requested",
  "lists.membershipState.held": "Held for approval",
  "lists.membershipState.rejected": "Declined",
  "lists.membershipState.filtered": "Filtered",
  "lists.membershipState.excluded": "Excluded",
  "lists.membershipState.unresolved": "Couldn't match",
  "lists.membershipState.blockedPermission": "Not permitted",
  "lists.membershipState.discover": "Discover only",
  "lists.membershipState.pending": "Waiting",
  "lists.runOutcome.succeeded": "Succeeded",
  "lists.runOutcome.failed": "Failed",
  "lists.runOutcome.skipped": "Skipped",
  "lists.counts.inLibrary": "In library",
  "lists.counts.added": "Added",
  "lists.counts.requested": "Requested",
  "lists.counts.held": "Held",
  "lists.counts.filtered": "Filtered",
  "lists.counts.excluded": "Excluded",
  "lists.counts.unresolved": "Couldn't match",
  "lists.counts.empty": "Nothing synced yet",
  "lists.follow.title": "Follow list",
  "lists.follow.editTitle": "Edit list",
  "lists.follow.submit": "Follow list",
  "lists.follow.sourceHeading": "List details",
  "lists.follow.name": "Name",
  "lists.follow.kinds": "Include",
  "lists.follow.modeHeading": "When a new title appears",
  "lists.follow.routesHeading": "Where titles go",
  "lists.follow.routesHelp": "Each kind of title needs a library. Kinds without one are never added.",
  "lists.follow.filtersHeading": "Filters",
  "lists.follow.syncHeading": "Sync",
  "lists.follow.maxPerSync": "Most titles per sync",
  "lists.follow.maxPerSyncPlaceholder": "No limit",
  "lists.follow.maxPerSyncHelp": "Titles over the limit wait for the next sync.",
  "lists.follow.onLeave": "When a title leaves the list",
  "lists.follow.onLeaveHelp": "Only applies to titles this list added and no other list still holds. Lists never delete titles.",
  "lists.follow.interval": "The provider sets the schedule: every {{interval}}.",
  "lists.follow.problem.name": "Give the list a name.",
  "lists.follow.problem.kinds": "Include at least one kind of title.",
  "lists.follow.problem.mode": "Choose what happens to new titles.",
  "lists.follow.problem.route": "Choose a library for every included kind.",
  "lists.follow.problem.maxPerSync": "The limit must be at least 1.",
  "lists.follow.problem.params": "Fill in the required list details.",
  "lists.route.heading": "{{kind}}",
  "lists.route.noLibrary": "You don't manage a library for this kind of title.",
  "lists.filter.rating": "Minimum rating",
  "lists.filter.ratingScale": "Rating source",
  "lists.filter.ratingPlaceholder": "Any",
  "lists.filter.scale.tmdb": "TMDB",
  "lists.filter.scale.imdb": "IMDb",
  "lists.filter.releaseYear": "Release year",
  "lists.filter.yearFrom": "From",
  "lists.filter.yearTo": "To",
  "lists.filter.excludeGenres": "Skip genres",
  "lists.filter.excludeGenresPlaceholder": "horror, documentary",
  "lists.filter.languages": "Original languages",
  "lists.filter.languagesPlaceholder": "en, ja",
  "lists.filter.releasedOnly": "Released titles only",
  "lists.filter.releasedOnlyHelp": "Skip titles that haven't been released yet. They are checked again on every sync.",
  "lists.preview.heading": "Preview",
  "lists.preview.nextSyncHeading": "Next sync would add",
  "lists.preview.run": "Preview",
  "lists.preview.notRun": "Preview the list to see what the first sync would add.",
  "lists.preview.failed": "Couldn't preview this list.",
  "lists.preview.total": "On list",
  "lists.preview.inLibrary": "In library",
  "lists.preview.wouldAdd": "Would add",
  "lists.preview.filtered": "Filtered",
  "lists.preview.excluded": "Excluded",
  "lists.preview.unresolved": "No match",
  "lists.preview.unresolvedHelp": "{{count}} titles couldn't be matched yet. They are retried on every sync.",
  "lists.preview.wouldAddHeading": "Titles the next sync would add",
  "lists.preview.nothingToAdd": "Nothing new to add right now.",
  "lists.detail.coverage": "Coverage",
  "lists.detail.settings": "Settings",
  "lists.detail.interval": "Schedule",
  "lists.detail.nextSync": "Next sync",
  "lists.detail.noCap": "No limit",
  "lists.detail.openAtProvider": "Open at the provider",
  "lists.detail.pausedUntil": "The provider asked Scryer to slow down. Syncing resumes after {{time}}.",
  ...
  "lists.status.followed": "Following {{name}}.",
  "lists.status.updated": "Saved {{name}}.",
  "lists.status.unfollowed": "Stopped following {{name}}.",
  "lists.status.syncQueued": "Syncing {{name}}.",
  ...
  "lists.exclusions.idsHelp": "Separate with commas, as source:id.",
  "lists.exclusions.scopeLabel": "Applies to",
  "lists.exclusions.scopeAll": "All lists",
  "lists.exclusions.scopeList": "Only {{name}}",
  "lists.exclusions.add": "Exclude",
  "lists.exclusions.added": "{{name}} is excluded from lists.",
  "lists.exclusions.removed": "{{name}} can be added by lists again.",
  "lists.exclusions.empty": "No titles are excluded.",
  "lists.exclusions.created": "Added",
  "lists.exclusions.remove": "Remove exclusion for {{name}}",
  "lists.exclusions.removeTitle": "Remove exclusion for {{name}}?",
  "lists.exclusions.removeDescription": "Lists may add this title again on their next sync.",
  ...
  "lists.policy.member": "Member",
  "lists.policy.requests30d": "List requests (30 days)",
  "lists.policy.policy": "Policy",
  "lists.policy.policyFor": "List policy for {{name}}",
  "lists.policy.value.auto": "Auto-approve",
  "lists.policy.value.approval": "Needs approval",
  "lists.policy.value.none": "Lists not allowed",
  "lists.note.tmdb_commercial": "TMDb lists are free for personal use. Using them commercially needs an agreement with TMDb.",
  "lists.note.mdblist_dynamic": "MDBList recalculates its dynamic lists on its own schedule, so titles can join or leave between syncs.",
  "lists.note.custom_prefer_ids": "Custom feeds match best when each item carries an ID such as IMDb, TMDb or TVDB. Items with only a title can match the wrong one.",
  "lists.note.plex_watchlist_endpoint": "Turn on the watchlist RSS feed in Plex first. Plex has changed this feed's address before, so a sync that suddenly fails may need the new address.",
  "lists.providerSettings.heading": "Provider settings",
  "lists.providerSettings.copy": "Shared by every list from this provider on this server.",
  "lists.providerSettings.required": "Required",
  "lists.providerSettings.secretStored": "Stored",
  "lists.providerSettings.secretEmpty": "Not set",
  "lists.providerSettings.secretPlaceholder": "Leave blank to keep the stored value",
  "lists.providerSettings.clearSecret": "Clear",
  "lists.providerSettings.keepSecret": "Keep",
  "lists.providerSettings.save": "Save settings",
  "lists.providerSettings.saved": "Provider settings saved.",
  "title.listProvenance.added": "Added by list {{name}}",
  "title.listProvenance.left": "Left the list {{name}}",
};
