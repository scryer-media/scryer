...
pub const SEASON_FOLDER_TEMPLATE_KEY: &str = "season_folder.template";
...
pub const DEFAULT_SEASON_FOLDER_TEMPLATE_SERIES: &str = "Season {season:2}";
pub const DEFAULT_SEASON_FOLDER_TEMPLATE_ANIME: &str = "Season {season_order:2}";
