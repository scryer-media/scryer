...
mod tests {
    ...
    fn notification_sample_events() -> Vec<DomainEvent> {
        vec![
            ...
            list_sample_event(18, list_sample_request(false)),
            list_sample_event(19, list_sample_request(true)),
            list_sample_event(
                20,
    ...
    fn list_events_build_plain_words_notifications() {
        ...
        assert_eq!(notification_scope_facet(&events[17]), Some("movie"));
    }
